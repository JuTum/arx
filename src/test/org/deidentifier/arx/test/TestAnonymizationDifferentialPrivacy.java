...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10), "./data/adult.csv", -372.6418664280325, new int[] { 0, 3, 0, 1, 3, 1, 2, 1, 1 }, false) },
                                              /* 20 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 2d, 1d, 1E-5d, 10), "./data/adult.csv", -359.69884638737096, new int[] { 0, 4, 0, 1, 1, 2, 2, 2, 0 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10), "./data/fars.csv", -1070.2121839621404, new int[] { 4, 1, 3, 2, 0, 1, 2, 0 }, false) },
                                              /* 30 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 2d, 1d, 1E-5d, 10), "./data/fars.csv", -1147.6071721311475, new int[] { 2, 0, 3, 3, 0, 1, 3, 0 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "./data/adult.csv", 231.53225806451613, new int[] { 1, 4, 0, 2, 3, 2, 2, 2, 0 }, false, "salary-class") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "./data/cup.csv", 353.61290322580646, new int[] { 5, 4, 0, 1, 1, 4, 4, 4 }, false, "GENDER") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "./data/fars.csv", 914.5967741935484, new int[] { 5, 2, 3, 3, 1, 0, 3, 1 }, false, "ihispanic") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 10), "./data/adult.csv", 237.5, new int[] { 0, 3, 1, 2, 2, 2, 2, 2, 0 }, false, "salary-class") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 10), "./data/cup.csv", 357.11290322580646, new int[] { 5, 3, 0, 0, 1, 4, 4, 4 }, false, "GENDER") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 10), "./data/fars.csv", 959.1935483870968, new int[] { 5, 1, 3, 3, 1, 0, 3, 1 }, false, "ihispanic") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 100), "./data/adult.csv", 237.5, new int[] { 0, 3, 1, 2, 2, 2, 2, 2, 0 }, false, "salary-class") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 100), "./data/cup.csv", 353.96774193548384, new int[] { 5, 3, 0, 1, 1, 3, 2, 3 }, false, "GENDER") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 100), "./data/fars.csv", 953.6935483870968, new int[] { 5, 0, 2, 2, 1, 0, 3, 2 }, false, "ihispanic") },
        });
    }
